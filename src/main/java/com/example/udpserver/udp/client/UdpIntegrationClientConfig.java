package com.example.udpserver.udp.client;
...
public class UdpIntegrationClientConfig {
    ...
    public UnicastSendingMessageHandler unicastSendingMessageHandler() {
        UnicastSendingMessageHandler unicastSendingMessageHandler = new UnicastSendingMessageHandler("27.38.172.185", udpPort);
